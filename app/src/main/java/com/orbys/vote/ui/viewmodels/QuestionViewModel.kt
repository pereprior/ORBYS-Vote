...
class QuestionViewModel @Inject constructor(
    ...
    fun getServerUrl(endpoint: String, isHotspot: Boolean = false) = networkManager.getServerWifiUrl(endpoint, isHotspot)
    ...
    fun checkNetworkOnActivity(activity: AppCompatActivity) { viewModelScope.launch { networkManager.checkNetworkOnActivity(activity) } }
}